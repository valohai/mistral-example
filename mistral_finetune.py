...
# train_dataset = load_dataset('/valohai/inputs/train_data/')
# eval_dataset = load_dataset('/valohai/inputs/val_data/')
# test_dataset = load_dataset('/valohai/inputs/test_data/')
...
# base_model_id = valohai.inputs("model").path()
...
model = AutoModelForCausalLM.from_pretrained(base_model_id, quantization_config=bnb_config, local_files_only=True)
